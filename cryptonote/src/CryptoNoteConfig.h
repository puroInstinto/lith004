...
const uint64_t CRYPTONOTE_PUBLIC_ADDRESS_BASE58_PREFIX       = 0x4bcf; // addresses start with "i"
...
const uint64_t FINAL_SUBSIDY_PER_MINUTE			     = UINT64_C(200000000000);
...
const size_t   CRYPTONOTE_BLOCK_GRANTED_FULL_REWARD_ZONE_V1  = 50000;
const size_t   CRYPTONOTE_BLOCK_GRANTED_FULL_REWARD_ZONE_CURRENT = CRYPTONOTE_BLOCK_GRANTED_FULL_REWARD_ZONE;
const size_t   CRYPTONOTE_COINBASE_BLOB_RESERVED_SIZE        = 600;
const size_t   CRYPTONOTE_DISPLAY_DECIMAL_POINT              = 10;
const uint64_t MINIMUM_FEE                                   = UINT64_C(10000000);    // pow(10, 5)
const uint64_t DEFAULT_DUST_THRESHOLD                        = UINT64_C(10000000);    // pow(10, 5)
...
const uint32_t KEY_IMAGE_CHECKING_BLOCK_INDEX                = 2000000; //Cual es su uso?
const uint32_t UPGRADE_HEIGHT_V2                             = 10000;
const uint32_t UPGRADE_HEIGHT_MAX_BLOCK_SIZE		     = 15000;
...
const CheckpointData CHECKPOINTS[] = {
	//{ 1, "0fef80633151b6cca55117976bad0e954b5a281efcceec0920d8d6fc53ccc849"}
};
}
